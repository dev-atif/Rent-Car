...
import car from "../../../public/car1.jpeg";
      ...
      <div>
        <div className="relative h-[350px] sm:h-[250px] md:h-[300px] lg:h-[400px] xl:h-[300px]">
          <Image
            src={item.image}
            fill
            className="object-cover w-full h-full mix-blend-screen rounded-t-xl"
            alt="Cars"
          />
        </div>
        <div className="p-4">
          ...
          <div className="flex items-center gap-10">
            <section className="flex items-center justify-between w-full">
              <article className="flex items-center gap-2 800">
                <span className="lg:text-2xl text-xl">
                  <FaUsers color="#0D274E" />
                </span>
